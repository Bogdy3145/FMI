...
class UI:
    ...
    def show_filter_menu():
        print("     1. Filter movies by id")
        print("     2. Filter movies by title")
        print("     3. Filter movies by description")
        print("     4. Filter movies by genre")
        print("     5. Return to the movies menu")
                    ...
                    if (x==9):
                        ...
                        while True:
                            ...
                            if (x == 9):
                                ...
                                list = self.__functions.filter_movies_id(param)
                                for l in list:
                                    print(l)

                            elif x == 2:
                                param = input("Keyword to filter: ")
                                list = self.__functions.filter_title(param)
                                for l in list:
                                    print(l)

                            elif x == 3:
                                param = input("Keyword to filter: ")
                                list = self.__functions.filter_description(param)
                                for l in list:
                                    print(l)

                            elif x == 4:
                                param = input("Keyword to filter: ")
                                list = self.__functions.filter_genre(param)
                                for l in list:
                                    print(l)
